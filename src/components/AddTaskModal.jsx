...
export default function AddTaskModal({ isOpen, onClose, onAdd, defaultDate }) {
  const [title, setTitle] = useState("");
  const [date, setDate] = useState(defaultDate || toLocalYYYYMMDD(new Date()));
  ...
  useEffect(() => {
    if (isOpen) {
      setDate(defaultDate || toLocalYYYYMMDD(new Date()));
      setTitle("");
      setTime("");
      setPriority("Medium");
      setCompleted(false);
